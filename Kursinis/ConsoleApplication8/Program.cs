    ...
    class Program
    {
        static void Main(string[] args)
        {
           ...
           // Constants2 c01 = new Constants2(0.0008, 0.00001, 0.0004, 0.000001, 0.00000001, 80, 40, 120);
            ...
            /*Console.WriteLine("Tikras:     "+value1);
            Console.WriteLine("Analitinis  "+value12);
            Console.ReadLine();*/
            ...
            /*for (int i = 0; i <= 64; i++)
            {
                Console.WriteLine("*************Skaitiklis1: "+i+" **************");
                value1 = count(d1, d2, Vm, S0);
                Console.WriteLine("Pirma reikšmė: "+value1);
                value12 = count(d1, d2, Vm, S0+S0*dif);
                Console.WriteLine("Antra reikšmė: "+value12);
                stack_Electricity.Push((value12 - value1) * (S0 + S0*dif) / (( S0 + S0 * dif - S0 ) * value12));
                Console.WriteLine("Bendra reikšmė: "+stack_Electricity.Peek());
                Console.WriteLine("++++++++++++++++++++++++++++++++++++++++++++++");
                value2 = countOld(d1, d2, Vm, S0);
                Console.WriteLine("Pirma reikšmė: " + value2);
                value22 = countOld(d1, d2, Vm, S0+S0*dif);
                Console.WriteLine("Antra reikšmė: " + value22);
                stack_ElectricityOld.Push((value22 - value2) * (S0 + S0 * dif) / ((S0 + S0 * dif - S0) * value22));
                Console.WriteLine("Bendra reikšmė: " + stack_ElectricityOld.Peek());
                stack_S0.Push(S0);
                S0 = S0 * 1.2;
                Console.WriteLine("*************Pabaiga: " + i + " **************");
                Console.WriteLine("Skirtumo reikšmė: " + (stack_Electricity.Peek()-stack_ElectricityOld.Peek()));
            }
